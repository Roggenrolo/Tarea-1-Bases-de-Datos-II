...
exec InsertarCanton 'Gu�cima';
exec InsertarCanton 'Guatuso';
exec InsertarCanton 'Heredia';
exec InsertarCanton 'Hojancha';
exec InsertarCanton 'Jim�nez';
exec InsertarCanton 'La Cruz';
exec InsertarCanton 'La Uni�n' ;
exec InsertarCanton 'Le�n Cort�s';
exec InsertarCanton 'Liberia';
exec InsertarCanton 'Lim�n';
...
if @id_partido != 0 begin
	...
	exec InsertarEntregable '2023-09-03', 20, 'calles', @id_accion, 'Escaz�';
...
if @id_partido != 0 begin
	exec @id_plan_gobierno = InsertarPlanGobierno @id_partido;
	exec @id_accion = InsertarAccion 'Reparar tuber�as', @id_plan_gobierno;
	exec InsertarEntregable '2022-06-09', 200, 'tuber�as', @id_accion, 'Puriscal';
	exec InsertarEntregable '2023-05-18', 120, 'tuber�as', @id_accion, 'Puntarenas';
	exec InsertarEntregable '2024-02-12', 230, 'tuber�as', @id_accion, 'Cartago';
end

exec @id_partido = InsertarPartido
	'El partido que por v�a democr�tica va a mejorar la democracia',
	'*foto del partido democr�tico*',
	'*bandera del partido democr�tico*',
	'Partido democr�tico'
;
if @id_partido != 0 begin
	exec @id_plan_gobierno = InsertarPlanGobierno @id_partido;
	...
	exec InsertarEntregable '2022-07-21', 19, 'cuadras', @id_accion, 'San Jos�';
	exec InsertarEntregable '2024-12-1', 38, 'cuadras', @id_accion, 'Liberia';
	exec InsertarEntregable '2021-10-29', 38, 'cuadras', @id_accion, 'Cartago';
end
